            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="dashboard-job"><span class="badge rounded-pill text-bg-success float-end" key="t-new">@lang('New')</span> <span key="t-jobs">@lang('Jobs')</span></a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="ui-notifications" key="t-notifications">@lang('Notifications')</a></li>
                         <li><a href="ui-utilities"><span key="t-utilities">@lang('Utilities')</span> <span class="badge rounded-pill bg-success float-end" key="t-new">@lang('New')</span></a></li>
                    </ul>
                </li>
