        ...
        <div class="d-flex">
            ...
            <div class="dropdown dropdown-mega d-none d-lg-block ml-2">
                <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown" aria-haspopup="false" aria-expanded="false">
                    <span key="t-megamenu">เมนูรวม</span>
        ...
        <div class="d-flex">
            ...
            <!-- <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    @break
                    @default
                    <img src="{{ URL::asset('/assets/images/flags/thailand.png')}}" alt="Header Language" height="22"> <span class="align-middle"> ไทย</span>
                    @endswitch
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    <a href="{{ URL::to('change/en') }}" class="dropdown-item notify-item language">
                        <img src="{{ URL::asset ('/assets/images/flags/us.jpg') }}" alt="user-image" class="me-1" height="12"> <span class="align-middle">English</span>
                    </a>
                    <a href="{{ URL::to('change/th') }}" class="dropdown-item notify-item language">
                        <img src="{{ URL::asset ('/assets/images/flags/thailand.png') }}" alt="user-image" class="me-1" height="18"> <span class="align-middle">ไทย</span>
                    </a>

                    //เรียกใช้ {{ trans('message.Search')}}
                </div>
            </div> -->
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-dashboard" role="button">
                            <i class="bx bx-home-circle me-2"></i><span key="t-dashboards">{{ trans('message.Home') }}</span>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-pages" role="button">
                            <i class="bx bx-customize me-2"></i><span key="t-apps">ผู้ดูแลระบบ (Admin) </span>
                            <div class="arrow-down"></div>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                            <a href="chat" class="dropdown-item" key="t-chat">@lang('Chat')</a>
