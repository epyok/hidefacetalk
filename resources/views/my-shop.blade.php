        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                    <h5 class="mb-0 card-title flex-grow-1">{{ trans('message.My product') }}</h5>
                    <a href="{{ route('addproduct') }}" class="btn btn-primary"><i class="bx bx-plus me-1"></i>{{ trans('message.Add product') }}</a>
                </div>
                <div class="table-responsive">
                    <table id="datatable" class="table align-middle table-nowrap mb-0">
                        <thead class="table-light">
                            <tr>
                                <th class="align-middle">{{ trans('message.No.') }}</th>
                                <th class="align-middle">{{ trans('message.Image') }}</th>
                                <th class="align-middle">{{ trans('message.Products ID') }}</th>
                                <th class="align-middle">{{ trans('message.Products Name') }}</th>
                                <th class="align-middle">{{ trans('message.Products Type') }}</th>
                                <th class="align-middle">{{ trans('message.Created Date') }}</th>
                                <th class="align-middle">ราคาปัจจุบัน</th>
                                <th class="align-middle">สถานะสินค้า</th>
                                <th class="align-middle">{{ trans('message.Details') }}</th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        @endphp
                            <tr>
                                <td>{{ $key+1 }}</td>
                                <th><img src="{{ asset('assets/images/upload/products_img/'.$product_img->product_img_url) }}" width="50pt" height="50pt"></th>
                                <td><a href="javascript: void(0);" class="text-body fw-bold">{{ $val->product_id }}</a> </td>
                                ...
                                <td>
                                    @if($val->product_bid_price <> '')
                                    {{ number_format(" $val->product_bid_price",2) }}
                                    @elseif($val->product_open_price > 0 )
                                    {{ number_format(" $val->product_open_price",2) }}
                                    @else
                                    {{ 0 }}
                                    @endif
                                </td>
